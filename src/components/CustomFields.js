...
var CustomFields = function (token, request) {
	this.token = token;
 ...
 */
CustomFields.prototype.set_custom_field_value = function (
	task_id,
	field_id,
	data
) {
 ...
 */
CustomFields.prototype.remove_custom_field_value = function (
	task_id,
	field_id
) {
	var token = this.token;
